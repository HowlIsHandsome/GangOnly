...
local HowlSilent = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/xqva/silent/main/silent.lua"))()
HowlSilent["TeamCheck"] = false
...
mt.__index = newcclosure(function(t, k)
    if t:IsA("Mouse") and (k == "Hit" or k == "Target") then
        if HowlSilent.checkSilentAim() then
            local CPlayer = rawget(HowlSilent, "Selected")
